    ...
    <Layout usePadding={false}>
      <div className="bg-white py-16 sm:py-24">
        <div className="relative sm:py-16">
          ...
          <div className="mx-auto max-w-lg px-4 sm:max-w-3xl sm:px-6 lg:max-w-5xl lg:px-8">
            <div className="relative rounded-2xl px-6 py-10 bg-indigo-600 overflow-hidden shadow-xl sm:px-12 sm:py-20">
              ...
              <div className="relative">
                <div className="sm:text-center">
                  <h2 className="text-4xl font-extrabold text-white tracking-tight sm:text-6xl">
                    Supabase + Next.js
                  </h2>
